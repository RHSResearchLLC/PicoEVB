...
xv_path="/home/dr/Programs/Xilinx/Vivado/2016.4"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L blk_mem_gen_v8_3_5 -L fifo_generator_v13_1_3 -L xdma_v3_0_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xdma_0 xil_defaultlib.xdma_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim xdma_0 -key {Behavioral:sim_1:Functional:xdma_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/dr/Programs/Xilinx/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
